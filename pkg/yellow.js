...
* @param {string} ev
*/
export function keyboard_event_up(ev) {
    const ptr0 = passStringToWasm0(ev, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.keyboard_event_up(ptr0, len0);
}

/**
* @param {string} ev
*/
export function keyboard_event_down(ev) {
    const ptr0 = passStringToWasm0(ev, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.keyboard_event_down(ptr0, len0);
}
...
* @param {number} height
*/
export function resize_event(width, height) {
    wasm.resize_event(width, height);
}
...
* @param {number} y
*/
export function touch_event_up(x, y) {
    wasm.touch_event_up(x, y);
}
...
* @param {number} y
*/
export function touch_event_down(x, y) {
    wasm.touch_event_down(x, y);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('yellow_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
